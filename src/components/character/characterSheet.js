const characterSheet = {
    STR: { key: "STR", value: 80, name: { zh: "力量", en: "STR" } },
    CON: { key: "CON", value: 60, name: { zh: "体质", en: "CON" } },
    POW: { key: "POW", value: 70, name: { zh: "意志", en: "POW" } },
    DEX: { key: "DEX", value: 60, name: { zh: "敏捷", en: "DEX" } },
    APP: { key: "APP", value: 50, name: { zh: "外表", en: "APP" } },
    SIZ: { key: "SIZ", value: 50, name: { zh: "体型", en: "SIZ" } },
    INT: { key: "INT", value: 50, name: { zh: "智力\n灵感", en: "INT\nIdea" } },
    EDU: { key: "EDU", value: 40, name: { zh: "教育", en: "EDU" } },
    ...
    skills: {
        ...
        appraise: { key: "appraise", value: 5, name: { zh: "估价", en: "Appraise" }, description: { en: "Can estimate the value of a particular item, including the quality, material used, and workmanship." }, checked: false },
        archaeology: { key: "archaeology", value: 1, name: { zh: "考古学", en: "Archaeology" }, description: { en: "Allows dating and identification of artifacts from past cultures, and the detection of fakes." }, checked: false },
        ...
        photography: { key: "photography", value: 5, name: { zh: "摄影", en: "Photography" }, checked: false, line: true },
        custom_art1: { key: "custom_art1", value: 5, checked: false, line: true },
        ...
        climb: { key: "climb", value: 20, name: { zh: "攀爬", en: "Climb" }, description: { en: "Can climb trees, walls, and other vertical surfaces with or without ropes and climbing gear." }, checked: false },
        credit: { key: "credit", value: undefined, name: { zh: "信用评级", en: "Credit Rating" }, description: {}, noBox: true },
        cthulhu: { key: "cthulhu", value: 0, name: { zh: "克苏鲁神话", en: "Cthulhu Mythos" }, description: {}, noBox: true },
        disguise: { key: "disguise", value: 5, name: { zh: "乔装", en: "Disguise" }, description: { en: "This is used whenever you wish to appear to be someone other than whom you are." }, checked: false },
        ...
        drive: { key: "drive", value: 20, name: { zh: "汽车驾驶", en: "Drive Auto" }, description: { en: "Drive a car or light truck, make ordinary maneuvers, and cope with ordinary vehicle problems. If the investigator wants to lose a pursuer or tail someone, a Drive roll would be appropriate." }, checked: false },
        ...
        fighting: { key: "fighting", value: 25, name: { zh: "格斗(斗殴)", en: "Fighting (Brawl)" }, description: { en: "A character’s skill in melee combat. You may spend skill points to purchase any skill specialization from Brawl (includes knives and clubs, as well as fisticuffs and martial arts), Sword, Axe, Spear, or Whip." }, checked: false },
        ...
        first_aid: { key: "first_aid", value: 30, name: { zh: "急救", en: "First Aid" }, description: { en: "Emergency medical care, it cannot be used to treat diseases (where the Medicine skill is required). To be effective, First Aid must be delivered within one hour of injury, in which case it grants 1 hit point and can rouse an unconscious person." }, checked: false },
        history: { key: "history", value: 5, name: { zh: "历史", en: "History" }, description: { en: "Recall a historical detail or event, the significance of a country, city, region, or person, as pertinent." }, checked: false },
        intimidate: { key: "intimidate", value: 15, name: { zh: "恐吓", en: "Intimidate" }, description: { en: "The use of threats (physical or psychological) to compel someone to act or reveal information. This skill can be opposed by Intimidate or Psychology." }, checked: false },
        ...
        latin: { key: "latin", value: 1, name: { zh: "拉丁语", en: "Latin" }, checked: false, line: true },
        custom_lang1: { key: "custom_lang1", value: 1, checked: false, line: true },
        ...
        lang_own: { key: "lang_own", value: undefined, checked: false, line: true },

        law: { key: "law", value: 5, name: { zh: "法律", en: "Law" }, description: { en: "Represents the chance of knowing pertinent law, precedent, legal maneuvers, or court procedure. Helps when dealing with the police, lawyers, and courts." }, checked: false },
        library: { key: "library", value: 20, name: { zh: "图书馆使用", en: "Library Use" }, description: { en: "Find a piece of information, such as a certain book, newspaper, reference in a library, or collection of documents (assuming the information is there to be found). Use of this skill marks several hours of continuous search." }, checked: false },
        listen: { key: "listen", value: 20, name: { zh: "聆听", en: "Listen" }, description: { en: "Interpret and understand sound, including overheard conversations, mutters behind a closed door, and whispered words in a cafe." }, checked: false },
        locksmith: { key: "locksmith", value: 1, name: { zh: "锁匠", en: "Locksmith" }, description: { en: "Open car doors, hot-wire autos, jimmy library windows, figure out Chinese puzzle boxes, and penetrate ordinary alarm systems. May repair locks, make keys, or open locks with the aid of skeleton keys, pick tools, or other tools." }, checked: false },
        ...
        medicine: { key: "medicine", value: 1, name: { zh: "医学", en: "Medicine" }, description: { en: "Diagnose and treat accidents, injuries, diseases, poisonings, etc. Treatment takes a minimum of one hour and can be delivered any time after damage is taken, but if this is not performed on the same day, the difficulty level of the roll is increased (requiring a Hard success). A person treated successfully with Medicine recovers 1D3 hit points (in addition to any First Aid they have received), except in the case of a dying character, who must initially receive successful First Aid to stabilize them before a Medicine roll is made." }, checked: false },
        nature: { key: "nature", value: 10, name: { zh: "博物学", en: "Nature World" }, description: { en: "Represents the traditional (unscientific) knowledge and personal observation of farmers, fishermen, inspired amateurs, and hobbyists. It can identify plant and animal species, habits, and habitats in a general way, as well as identify tracks, spoors, and animal or bird calls." }, checked: false },
        ...
        psychology: { key: "psychology", value: 10, name: { zh: "心理学", en: "Psychology" }, description: { en: "Perception, common to all humans, to form an idea of another person’s motives and character, and detect if a person is lying. The Keeper may choose to make concealed Psychology skill rolls on the player’s behalf, announcing only the information, true or false, that the user gained by employing it." }, checked: false },
        ...
        biology: { key: "biology", value: 1, name: { zh: "生物学", en: "Biology" }, checked: false, line: true },
        pharmacy: { key: "pharmacy", value: 1, name: { zh: "药学", en: "Pharmacy" }, checked: false, line: true },
        custom_sci: { key: "custom_sci", value: 1, checked: false, line: true },
        ...
        track: { key: "track", value: 10, name: { zh: "追踪", en: "Track" }, description: { en: "Follow a person, vehicle, or animal over earth, and through plants. Factors such as time passed since the tracks were made, rain, and the type of ground covered may affect the difficulty level of the roll." }, checked: false },
        custom_unused1: { key: "custom_unused1", disabled: true, line: true },
        custom_unused2: { key: "custom_unused2", disabled: true, line: true },
        custom_unused3: { key: "custom_unused3", disabled: true, line: true },
        custom_unused4: { key: "custom_unused4", disabled: true, line: true },
        custom_unused5: { key: "custom_unused5", disabled: true, line: true },
    },
